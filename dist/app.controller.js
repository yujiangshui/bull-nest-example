...
let AppController = class AppController {
    constructor(userService, postService, licenseProducerService) {
        this.userService = userService;
        this.postService = postService;
        this.licenseProducerService = licenseProducerService;
    }
    async addLicenseProduct(productTitle) {
    ...
    async deleteLicenseProduct(productTitle) {
...
__decorate([
    (0, common_1.Get)('add-license-product'),
    __param(0, (0, common_1.Query)('productTitle')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "addLicenseProduct", null);
__decorate([
    (0, common_1.Get)('clear-license-product-queue'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AppController.prototype, "clearLicenseProductQueue", null);
__decorate([
    (0, common_1.Get)('delete-license-product'),
    __param(0, (0, common_1.Query)('productTitle')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "deleteLicenseProduct", null);
__decorate([
